...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child: Scaffold(
      backgroundColor: Colors.deepPurpleAccent, body: Center(
      child: Container(
          ...
          Container(
            ...
            child: Center(
              child: ButtonTheme(
                ...
                child: RaisedButton(child: _currentIndex == widget.quizes.length - 1
                  ? Text('결과보기') : Text('다음문제'),
                textColor: Colors.white, color: Colors.deepPurpleAccent,
